...
- **Blocking**: GitHub's native issue dependencies. Where unavailable, use a `Blocked by: #<n>, #<n>` line.
- **Frontier query**: list the map's open children, dropping assigned or blocked tickets; first in map order wins.
