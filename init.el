...
;; load-prefer-newer and `sanityinc/tui-session-p' are set in early-init.el
;; so they apply from the very start.
(unless (fboundp 'sanityinc/tui-session-p)
